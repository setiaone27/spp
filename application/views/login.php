...
<head>
  ...
  <title>SPPQu - Login Admin/Petugas</title>
                  ...
                  <form class="user" method="POST" id="login">                    
                    ...
                    <div class="form-group">
                      <div class="input-group mb-3">
                        ...
                        <input type="text" name="username" class="form-control" id="exampleInputUser" aria-describedby="emailHelp" placeholder="Username" required="required">
                      </div>
                    </div>
                    <div class="form-group">
